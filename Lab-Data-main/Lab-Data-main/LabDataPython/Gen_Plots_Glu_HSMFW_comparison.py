...
Glu_Acc = pd.read_csv("LabDataPython/Glucose_Acclimated_NewHeaders_PerGlucoseFed.csv")
Glu_Acc = Glu_Acc.fillna(0)
Glu_Unacc = pd.read_csv("LabDataPython/Glucose_Unacclimated_NewHeaders_PerGlucoseFed.csv")
